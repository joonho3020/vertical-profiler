...
def main():
  ...
  utils.bash(f"stackcollapse-tracerv.py {args.callstack} | \
       ...
       flamegraph.pl \
         ...
         --height 20 \
         --bgcolors \"#ffffff\" \
         --countname cycles > {args.callstack}.flamegraph.svg")

  print("Generating icicle graph")
  utils.bash(f"cat {args.callstack}.fold | \
       flamegraph.pl \
         --title=\"Flame Graph\" \
         --inverted \
         --colors blue \
         ...
         --height 20 \
         --bgcolors \"#ffffff\" \
         --countname cycles > {args.callstack}.icicle.svg")
